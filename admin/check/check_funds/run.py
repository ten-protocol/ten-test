...
class PySysTest(TenNetworkTest):
    ...
    def execute(self):
        ...
        self.assertTrue(validator1_balance >= 0, assertMessage='L1 Validator1 balance is non zero')
        self.assertTrue(validator2_balance >= 0, assertMessage='L1 Validator2 balance is non zero')
