...
class TenRunnerPlugin():
    ...
    def setup(self, runner):
        ...
        stats_db = StatsPersistence.init(True, self.user_dir, self.machine_name)
    ...
    def __set_contract_addresses(self, runner):
        ...
        if 'result' in response.json():
            ...
            if "PublicSystemContracts" in config:
                ...
                Properties.L2TransactionPostProcessor = self.__get_contract(contracts, "TransactionsPostProcessor")
