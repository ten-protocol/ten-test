...
class PySysTest(GenericNetworkTest):
    ...
    def execute(self):
        ...
        try:
            ...
            error.contract.functions.force_require().call({"gas":1000000})
        ...
        try:
            ...
            error.contract.functions.force_revert().call({"gas":1000000})
        except Exception as e:
            self.log.info('Exception type: %s', type(e).__name__)
            self.log.info('Exception args: %s', e.args[0])
        ...
        try:
            ...
            error.contract.functions.force_assert().call({"gas":1000000})
        except Exception as e:
            self.log.info('Exception type: %s', type(e).__name__)
            self.log.info('Exception args: %s', e.args[0])
