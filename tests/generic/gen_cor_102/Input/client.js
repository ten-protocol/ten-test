...
async function sendTransaction() {
  const unsignedTrx = await contract.populateTransaction.setItem('Key', 1, { gasLimit: 400000 } )
...
const signer = new ethers.Wallet(options.private_key, provider)
const contract = new ethers.Contract(options.address, abi, signer)
