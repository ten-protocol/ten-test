...
class PySysTest(GenericNetworkTest):
    ...
    def execute(self):
        ...
        # wait and validate
        self.waitForGrep(file=logout, expr='Received event type ItemSet1', condition='>= 3', timeout=10)
        self.waitForGrep(file=logout, expr='Received event type ItemSet2', condition='>= 3', timeout=10)
        self.waitForGrep(file=logout, expr='Received event type ItemSet3', condition='>= 3', timeout=10)
