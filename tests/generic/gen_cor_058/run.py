...
class PySysTest(TenNetworkTest):
    ...
    def execute(self):
        ...
        self.log.info('Balance account before %.6f ETH (%d Wei)', web3.from_wei(balance1, 'ether'), balance1)
        ...
        self.log.info('Balance account after %.6f ETH (%d Wei)', web3.from_wei(balance2, 'ether'), balance2)
    ...
    def send(self, network, web3, account, address, amount):
        ...
        self.log.info('Gas * price + value == %0.6f', web3.from_wei(gpv, 'ether'))
        tx = {
            'to': address,
            'value': amount,
            'gas': 72000,
