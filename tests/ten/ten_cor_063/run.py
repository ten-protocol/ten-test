...
class PySysTest(TenNetworkTest):
    ...
    def execute(self):
        ...
        # player 2 should see all events, player 1 should not see any
        ...
        for i in range(0, len(response)):
            ...
            self.assertTrue(response[i]['topic1Relevant'] == True)        # Field.TOPIC1 is set
            self.assertTrue(response[i]['topic2Relevant'] == False)       # Field.TOPIC2 is not set
