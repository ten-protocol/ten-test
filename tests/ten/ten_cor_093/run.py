...
from ten.test.contracts.emitter import TransparentEventEmitter, EventEmitterCaller
...
class PySysTest(GenericNetworkTest):
    ...
    def execute(self):
        ...
        emitter_1 = TransparentEventEmitter(self, web3_1)
        ...
        emitter_2 = TransparentEventEmitter.clone(web3_2, account_2, emitter_1)
        ...
        address_event_1 = emitter_1.contract.events.AddressEvent().process_receipt(tx_receipt_1, errors=DISCARD)[0]
        ...
        self.log.info('  addressEvent._address:       %s' % address_event_1['args']['_address'])
