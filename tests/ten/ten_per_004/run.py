...
class PySysTest(TenNetworkTest):
    ...
    def execute(self):
        ...
        data_binned = [self.bin_timestamp_data(first_ts, last_ts, d, OrderedDict()) for d in data]
        with open(os.path.join(self.output, 'clients_ts_all.bin'), 'w') as fp:
