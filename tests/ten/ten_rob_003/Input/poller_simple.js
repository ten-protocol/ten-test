...
commander
  ...
  .option('--contract1_address <value>', 'Contract1 address')
  .option('--contract1_abi <value>', 'Contract1 ABI file')
  .option('--contract2_address <value>', 'Contract2 address')
  .option('--contract2_abi <value>', 'Contract2 ABI file')
