...
class PySysTest(TenNetworkTest):
    ...
    def execute(self):
        ...
        self.assertTrue(response[1]['transactionHash'] == tx_receipt_2.transactionHash.hex())
        self.assertTrue(response[0]['defaultContract'] == True)
        self.assertTrue(response[1]['defaultContract'] == True)
