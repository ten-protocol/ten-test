...
class PySysTest(TenNetworkTest):
    ...
    def client(self, l2_network, bridge_address, bridge_abi, bus_address, bus_abi, private_key,
        ...
        node_url = 'http://%s:%s' % (Properties().validator_host(self.env), Properties().validator_port_http(self.env))
        ...
        self.waitForGrep(file=stdout, expr='Starting transaction to withdraw funds to the L1', timeout=10)
