...
class PySysTest(GenericNetworkTest):
    ...
    def execute(self):
        ...
        self.percentile_difference('times_once', int(tx1["gasUsed"]), est_1, 5)
        self.percentile_difference('times_twice', int(tx2["gasUsed"]), est_2, 5)
        self.percentile_difference('times_thrice', int(tx3["gasUsed"]), est_3, 5)
